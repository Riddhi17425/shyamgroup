...
class Associate_Team extends CI_Controller
{
    ...
    {
        $row = $this->projects_model->get_company_profile();
        // $data['meta_title']             = "";
        // $data['meta_description']       = "";
        $data['meta_image']             = base_url('images/og-default.jpg');
        $data['company_profile_detail'] = $row;
        ...
        $this->load->view('associate-team', $data);
    }
}
