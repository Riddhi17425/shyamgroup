    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/vender.png)">
                    ...
                    <div class="row">
                                    ...
                                    <div class="contact-info-box mb-5">
                                        ...
                                        <div class="contact-info-box-content">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <p>
                                                    T-5, 3rd Floor, Gokul Complex, Drive-In Road, Opp. Swaninarayan
                                                    Gurukul Temple, Gurukul, Ahmedabad-52.
                                                </p>
                                            </div>
                                            <!--<div>-->
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <span style="color:#FF0000"><?php //echo $this->session->flashdata('msg');
                                                        ?></span>
                            <form action="<?php echo base_url(); ?>Vender/send_mail" method="post" id="vendorForm"
                                name="vendorForm">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="company_name"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="contact_person"
                                                placeholder="" type="text" required=""
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="designation"
                                                placeholder="" type="text" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-email" name="email" placeholder=""
                                                type="email" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="contact_one"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="contact_two"
                                                placeholder=""
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 15);"
                                                type="text">
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-name" name="landline"
                                                placeholder="" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>GST No</label>
                                            <input class="form-control form-control-name" name="gst_no"
                                                placeholder="" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>PAN No</label>
                                            <input class="form-control form-control-name" name="pan_no"
                                                placeholder="" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Website</label>
                                            <input class="form-control form-control-subject" name="web_site"
                                                placeholder="" type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="g-recaptcha"
                                            data-sitekey="6LcYahEsAAAAALj0QYHkfniCG6LuVAOoI8dW8_T1"
                                            data-callback="verifyVendorCaptcha"></div>
                                        <!-- Hidden input for jQuery validation -->
                                        <input type="hidden" name="hiddenVendorRecaptcha"
                                            id="hiddenVendorRecaptcha">
                                    </div>
                                </div>
                                <div><br>
