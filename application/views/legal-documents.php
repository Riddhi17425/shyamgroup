    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/legel-documents.png)">
            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Legal Document</p>
                        </div>
                        <div class="col-md-2 col-xs-12">
                            ...
                            <div class="Legal_pdf_main">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 Legal_pdf_card">
                                        <a class="Legal_pdf" target="_new"
                                            href="<?php echo base_url(); ?>documents/pdf/pdf1.pdf"><img
                                                src="<?php echo base_url(); ?>images/new_images/pdf-icon.png" alt="image">
                                            Final Proposed Land Use Plan</a>
                                    </div>
                                    <div class="col-sm-3 Legal_pdf_card">
                                        <a class="Legal_pdf" target="_new"
                                            href="<?php echo base_url(); ?>documents/pdf/pdf2.pdf"><img
                                                src="<?php echo base_url(); ?>images/new_images/pdf-icon.png" alt="image">
                                            DP Report 1</a>
                                    </div>
                                    <div class="col-sm-3 Legal_pdf_card">
                                        <a class="Legal_pdf" target="_new"
                                            href="<?php echo base_url(); ?>documents/pdf/pdf3.pdf"><img
                                                src="<?php echo base_url(); ?>images/new_images/pdf-icon.png" alt="image">
                                            DP Report 2 – GDCR</a>
                                    </div>
                                    <div class="col-sm-3 Legal_pdf_card">
                                        <a class="Legal_pdf" target="_new"
                                            href="<?php echo base_url(); ?>documents/pdf/pdf4.pdf"><img
                                                src="<?php echo base_url(); ?>images/new_images/pdf-icon.png" alt="image">
                                            DP Sanction Notification</a>
                                    </div>
                                    <div class="col-sm-3 Legal_pdf_card">
                                        <a class="Legal_pdf" target="_new"
                                            href="<?php echo base_url(); ?>documents/pdf/pdf5.pdf"><img
                                                src="<?php echo base_url(); ?>images/new_images/pdf-icon.png" alt="image">
                                            Annual Report-DSIRDA 2022-23</a>
                                    </div>
                                </div>
                            </div>
