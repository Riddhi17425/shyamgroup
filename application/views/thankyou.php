    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/thank-you.png)">
            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Thank you</p>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="text-center"><img src="<?php echo base_url(); ?>documents/thanks.jpg" alt="image"
                                    style="width: 50%;"></div>
                        </div>
                    </div>
                    <!-- Container end -->
