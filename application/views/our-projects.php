    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/our-project.png)">
            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Our Projects</p>
                        </div>
                        <div class="col-md-2 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-bottom: 5%;">
                            <div class="ts-service-box">
                                <div class="ts-service-image-wrapper image-angle"> <img class="img-responsive"
                                        src="<?php echo base_url(); ?>documents/project_images/<?php echo $projects_list['image']; ?>"
                                        alt="image" style="width: 100%; height: 200px;" /> </div>
                                ...
                                <div class="row mt-5">
                                    <div class="col-sm-6">
                                        <a class="btn btn-primary"
                                            href="<?php echo base_url(); ?>documents/project_images/<?php echo $projects_list['project_brochure']; ?>"
                                            target="_new">View Brochure</a>
                                    </div>
                                    <div class="col-sm-6">
                                        <a class="btn btn-primary Our_Projects_btn2" href="<?php echo base_url() . $pname; ?>">Read
                                            More</a>
                                    </div>
                                </div>
                            </div>
