            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a>We Are Social </p>
                        </div>
                        <div class="col-md-2 col-xs-12">
                    ...
                    <div class="social_wrapper">
                        ...
                        <div class="inner_side_grid col-lg-4 mb-4">
                            <div class="single_instagram">
                                <a href="<?php echo $d['media_url']; ?>" target="_blank">
                                    <img src="<?php echo $d['media_url']; ?>" class="we-are-social-img" alt="image">
                                </a>
                            </div>
                        </div>
