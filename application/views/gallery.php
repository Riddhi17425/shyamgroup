    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/gallery.jpg)">
            </div>
                ...
                <div class="container">
                    <div class="coman_routs">
                        <div class="col-md-2 col-xs-12">
                            <h3 class="call-to-action-title">Gallery</h3>
                        </div>
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Gallery</p>
                        </div>
                        <div class="col-md-2 col-xs-12">
                    ...
                    <div class="row text-center">
                        <div class="isotope-nav" data-isotope-nav="isotope">
                            <ul class="tabs_gall">
                                ...
                                <li><a class="isotope-nav_link" data-filter=".dholeraglobalcity">Dholera Global City</a>
                                </li>
