    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/certificate.png)">
            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Certificates</p>
                        </div>
                        <div class="col-md-2 col-xs-12">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div id="page-slider" class="owl-carousel owl-theme page-slider page-slider-small">
                                <div class="item"> <img
                                        src="<?php echo base_url(); ?>documents/Shyam Infra-cert-ispl 001.jpg" alt="image">
                                </div>
                            </div>
                            <!-- Page slider end -->
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="page-slider" class="owl-carousel owl-theme page-slider page-slider-small">
                                <div class="item"> <img
                                        src="<?php echo base_url(); ?>documents/Vibrant Gujarat - Shyamgroup.jpg"
                                        alt="image"> </div>
                            </div>
                            <!-- Page slider end -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="page-slider" class="owl-carousel owl-theme page-slider page-slider-small">
                                <div class="item"> <img src="<?php echo base_url(); ?>documents/Crisil-Certificate.jpg"
                                        width="100%" height="100%" alt="image"> </div>
                            </div>
                            <!-- Page slider end -->
                        </div>
                        <!-- Slider col end -->
