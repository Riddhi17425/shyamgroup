                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="isotope">
                                ...
                                <div class="isotope-img-container" style="width: 50%; float: left;"> <a
                                        class="gallery-popup"
                                        href="<?php echo base_url(); ?>shyam_admin/upload/media/<?php echo $pressrelease_detail->image; ?>"> <img
                                            class="img-responsive"
                                            src="<?php echo base_url(); ?>shyam_admin/upload/media/<?php echo $pressrelease_detail->image; ?>"
                                            alt="image"> <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                    ...
                    <p class="project-cat">Commercial, Interiors</p>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="ts-team-wrapper">
                                <div class="team-img-wrapper"> <a
                                        href="<?php echo base_url(); ?>Dholera_News/detail/<?php echo $news_list['id']; ?>"><i
                                            class="fa fa-arrow-right"></i> <?php echo $news_list['title']; ?> </a> <span> </span>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
