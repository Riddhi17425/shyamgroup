    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/client.jpg)">
            ...
            <section class="call-to-action">
                <div class="container">
                    <div class="coman_routs">
                        ...
                        <div>
                            <p class="com_he_tab"> <a href="<?php echo base_url(); ?>home">Home ></a> Testimonial</p>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="quote-item">
                                <div>
                                    ...
                                    <div class="quote-item-footer"> <img class="testimonial-thumb"
                                            src="<?php echo base_url(); ?>images/banner/<?php echo $testimonial_list['photo']; ?>" alt="image">
                                        <div class="quote-item-info">
                                            <h3 class="quote-author"><?php echo $testimonial_list['name']; ?></h3>
