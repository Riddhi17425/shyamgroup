    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div id="banner-area" class="banner-area"
                style="background-image:url(<?php echo base_url(); ?>images/banner/vision-and-mission.png)">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <h4>Vision</h4>
                            <p>Shyam Group's vision is to bring growth to the community, deliver successful projects to
                                our customers and make their dreams becoming reality.</p>
                            <h4>Mission</h4>
                            <p>To safely deliver any project, on timely basis keeping in mind the safety of our
                                environment and at the same time provide benefits to our customers, shareholders,
                                employees and the communities we serve.</p>
                            <?php if ($vision_detail->brochure != '') {?>
                            <a href="<?php echo base_url(); ?>documents/cms_data/<?php echo $vision_detail->brochure; ?>" target="_new"
                                style="float: right;"><i class="fa fa-download"></i> Download Document</a>
                            <?php }?>
                        </div>
                        <div class="col-md-3">
                            <div class="row text-center">
