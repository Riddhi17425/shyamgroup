...
class Testimonial extends CI_Controller
{
	...
	{
		$data['tbl_blog']=$this->Testimonial_model->get_list();
	...
	{
		$this->Testimonial_model->insert_form();
		redirect("blog");
	}

	public function delete_row($news_blog_id)
	{   
		$this->Testimonial_model->delete_row($news_blog_id);
    	$this->index();
    }

	public function edit_blog($news_blog_id)
	{
    	$row=$this->Testimonial_model->edit_blog($news_blog_id);
		$data['blog']=$row;
