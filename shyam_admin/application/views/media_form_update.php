      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url(); ?>media/update_blog/<?php echo $blog->id; ?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <img src="<?php echo base_url(); ?>upload/media/<?php echo $blog->image;?>" width="70" height="50" style="margin-top: 2%;"/>
                    </div>
                  </div>
                </div>
