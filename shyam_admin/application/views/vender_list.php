          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($tbl_vender as $list): ?>
                <tr>
                  ...
                  <td><?php echo $list['contact_one']; ?></td>
                  <td><?php echo $list['contact_two']; ?></td>
                  <td><?php echo $list['landline']; ?></td>
                  <td><?php echo $list['gst_no']; ?></td>
